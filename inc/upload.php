...
if(isset($_POST['TrabajoID'])){
    if(empty($_POST['TrabajoID'])){
    ...
    if ($handle->uploaded) {
        ...
        if ($handle->processed) {
            ...
            */
            ...
            $FileDstName = $handle->file_dst_name;
            $res = $mysqli->query("UPDATE trabajos SET pdf = '".$FileDstName."' WHERE TrabajoID = ".$_POST['TrabajoID']);
            if($res){
